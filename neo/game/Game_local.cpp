...
// DG: msecPrecise is set based on com_gameHz cvar (default 120) for high-fps support.
// Previously was USERCMD_MSEC (static const).
float idGameLocal::msecPrecise = USERCMD_MSEC;
